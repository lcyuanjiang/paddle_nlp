...
class ModuleUtilsMixin:
    ...
    def _convert_head_mask_to_5d(self, head_mask, num_hidden_layers):
        ...
        assert head_mask.dim() == 5, "head_mask.dim != 5, instead {head_mask.dim()}"
    ...
    def generate(
        ...
        **model_specific_kwargs
        ...
        if self.config.is_encoder_decoder:
            ...
            ), "expected encoder_outputs[0] to have 1st dimension bs={batch_size}, got {encoder_outputs[0].shape[0]} "
